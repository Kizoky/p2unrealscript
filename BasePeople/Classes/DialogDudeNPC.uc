///////////////////////////////////////////////////////////////////////////////
// Same as DialogDude but extends DialogBlank instead of DialogMale
// It's for the NPC Dudes for DudeVSDude cheat code.
///////////////////////////////////////////////////////////////////////////////
class DialogDudeNPC extends DialogBlank;
...
//	AddTo(lDude_BuySteaks,						"DudeDialog.dude_needsomesteaks", 1);
	...
	Clear(lBattleCry);
	Addto(lBattleCry,							"DudeDialog.dude_getdownifyoudont", 1);
	}
