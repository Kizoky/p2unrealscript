...
// into the level to generate a random person of this type in AW.
//
//=============================================================================
class AWBystanders extends AWBystander
	placeable;
...
defaultproperties
{
	...
	ChameleonSkins(37)="End"
	ChameleonMeshPkgs(0)="Characters"
	bInnocent=True
	bUsePawnSlider=True
	Mesh=SkeletalMesh'Characters.Fem_SS_Shorts'
	Skins(0)=Texture'ChameleonSkins.BystandersF.XX__142__Fem_SS_Shorts'
	ControllerClass=Class'AWBystanderController'
}
