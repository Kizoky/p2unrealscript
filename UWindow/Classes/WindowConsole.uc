...
function UpdateHistory()
{
	...
	History[HistoryCur++ % ArrayCount(History)] = TypedStr;
	if( HistoryCur > HistoryBot )
		HistoryBot++;
	if( HistoryCur - HistoryTop >= ArrayCount(History) )
		HistoryTop = HistoryCur - ArrayCount(History) + 1;
}
...
function HistoryUp()
{
	...
	{
		History[HistoryCur % ArrayCount(History)] = TypedStr;
		TypedStr = History[--HistoryCur % ArrayCount(History)];
	}
}
