...
function FW_SetupWindowTitle(UWindowFramedWindow W, Canvas C); // RWS CHANGE: Set the window title's font and color
...
// RWS CHANGE: Added radio button functions
function RadioButton_SetupSizes(UWindowRadioButton W, Canvas C);
function RadioButton_Draw(UWindowRadioButton W, Canvas C);
...
// RWS CHANGE: Added functions to standardize control presentation
...
// RWS CHANGE: Added more sound functions
function PlayBigSound(UWindowWindow W);
function PlaySmallSound(UWindowWindow W);
function PlayOverSound(UWindowWindow W);
function PlayDownSound(UWindowWindow W);
// RWS CHANGE: Added frame drawing function
function DrawFrame(UWindowWindow W, Canvas C, float X, float Y, float Width, float Height);
// RWS CHANGE: Added function for playing local sounds
