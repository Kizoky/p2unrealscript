...
// RWS CHANGE: added more fonts (Fonts[] has room for 10)
const F_FancyS = 4;
const F_FancyM = 5;
const F_FancyL = 6;
const F_FancyXL = 7;
...
// Added small fonts
const F_Small = 8;			// Small font
const F_SmallBold = 9;		// Small, Bold font
...
enum TextAlign
{
	...
	TA_Right,
	TA_Center,
	TA_Custom,		// RWS CHANGE: Custom used for check boxes to align properly
	TA_LeftOfText	// RWS CHANGE: Put the checkbox to the left of the text
};
