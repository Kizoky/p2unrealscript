...
///////////////////////////////////////////////////////////////////////////////
class CatModePL extends P2GameMod;
...
function bool CheckReplacement(Actor Other, out byte bSuperRelevant)
{
	...
	// Check specifically for PL Bystanders.
	...
	if (Other.Class == class'Bystanders'
		|| Other.Class == class'PLBystanders'
		|| Other.Class == class'PLBystanders_AridDesert'
		|| Other.Class == class'PLBystanders_AshenSkies'
		|| Other.Class == class'PLBystanders_NuclearWinter'
		|| Other.Class == class'PLBystanders_RainyFoliage'
		)
	{
...
defaultproperties
{
	...
	FriendlyName="Cat Mode (PL)"
	// Description - optional short description of your Game Mod
	Description="Replaces generic bystanders with... cats! Now compatible with Paradise Lost. Never run out of money again!"
