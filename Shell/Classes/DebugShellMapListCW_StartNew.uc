...
///////////////////////////////////////////////////////////////////////////////
class DebugShellMapListCW_StartNew extends ShellMapListCW;

var string LaunchGameType;

function SetGameType(string GameType)
{
	LaunchGameType = GameType;
}
...
function LoadButtonClicked()
	...
	if (MapListBox.SelectedItem != None)
		{
		URL = ""$ShellMapListItem(MapListBox.SelectedItem).MapName$"?Game="$LaunchGameType;
