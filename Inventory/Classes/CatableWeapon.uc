...
//
// Not useable. This is a parent class to weapons like the shotgun,
// that can have a cat put on the end of them.
// That's all.
//
// Pitches shot sound with cat on end, higher and higher with
// each shot used with cat on gun.
//
// CatInv intiates the change, by telling this weapon to DownWeapon through
// a NextWeapon call, which then puts the cat on, then reselects this weapon back.
//
//=============================================================================

class CatableWeapon extends P2Weapon;
