 ...
 *
 * For the record, we're not gonna have dual wieldable grenades, we simply need
 * to use this as a base for the Launcher weapon as a way of it
 * inheriting both the Grenade and dual wield weapon functionality
 *
 * @author Gordon Cheng
 */
class DualGrenadeWeapon extends DualCatableWeapon //P2DualWieldWeapon
    abstract;
...
defaultproperties
{
	...
	PlayerViewOffset=(X=1.0000,Y=0.000000,Z=-15.0000)
