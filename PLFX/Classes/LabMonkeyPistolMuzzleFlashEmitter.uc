/**
 * LabMonkeyPistolMuzzleFlashEmitter
 *
 * A Muzzle Flash Emitter to be used with the Lab Monkey's Pistol
 *
 * @author Gordon Cheng
 */
class LabMonkeyPistolMuzzleFlashEmitter extends PLPersistantEmitter;
