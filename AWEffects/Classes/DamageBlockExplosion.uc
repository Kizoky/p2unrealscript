///////////////////////////////////////////////////////////////////////////////
// DamageBlockExplosion
// 
///////////////////////////////////////////////////////////////////////////////
class DamageBlockExplosion extends P2Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter94
         ...
         StartSizeRange=(X=(Min=90.000000,Max=110.000000))
         UniformSize=True
     ...
     End Object
     Emitters(0)=SpriteEmitter'AWEffects.SpriteEmitter94'
     AutoDestroy=True
}
