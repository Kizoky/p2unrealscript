class UBrowserOpenWindow extends UWindowFramedWindow;
...
function Created()
{
	...
	OKButton.Register(UBrowserOpenCW(ClientArea));
...
defaultproperties
{
	WindowTitle="Join Specific URL"
	ClientClass=class'UBrowserOpenCW'
	OKText="OK"
}