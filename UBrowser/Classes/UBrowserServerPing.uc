	...
	event ReceivedText( IpAddr Addr, string Text )
	{
		...
		do 
		{
			...
			else if(Left(Value, 10) == "character_")
			{
				...
				In = Out;
				PlayerEntry = Server.PlayerList.FindID(ID);
				PlayerEntry.PlayerCharacter = Value;
			}
/*
