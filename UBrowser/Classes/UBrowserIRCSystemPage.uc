class UBrowserIRCSystemPage extends UBrowserIRCPageBase;
...
function Created()
{
	...
	Splitter.SplitPos = 55;
	Splitter.MaxSplitPos = 75;
...
function NotifyQuitUnreal()
{
	...
	{
		// don't localize - sent to other clients
		Link.DisconnectReason = "Left POSTAL 2 Multiplayer Chat";
		Link.DestroyLink();
	}
}
