...
{
	W.DrawClippedTexture(C, 0, 0, Texture'UDebugMenu.BlueMenuTL');
	W.DrawStretchedTexture(C, 4, 0, W.WinWidth-8, 4, Texture'UDebugMenu.BlueMenuT');
	W.DrawClippedTexture(C, W.WinWidth-4, 0, Texture'UDebugMenu.BlueMenuTR');

	W.DrawClippedTexture(C, 0, W.WinHeight-4, Texture'UDebugMenu.BlueMenuBL');
	W.DrawStretchedTexture(C, 4, W.WinHeight-4, W.WinWidth-8, 4, Texture'UDebugMenu.BlueMenuB');
	W.DrawClippedTexture(C, W.WinWidth-4, W.WinHeight-4, Texture'UDebugMenu.BlueMenuBR');

	W.DrawStretchedTexture(C, 0, 4, 4, W.WinHeight-8, Texture'UDebugMenu.BlueMenuL');
	W.DrawStretchedTexture(C, W.WinWidth-4, 4, 4, W.WinHeight-8, Texture'UDebugMenu.BlueMenuR');

	W.DrawStretchedTexture(C, 4, 4, W.WinWidth-8, W.WinHeight-8, Texture'UDebugMenu.BlueMenuArea');
}
...
function ComboList_DrawItem(UWindowComboList Combo, Canvas C, float X, float Y, float W, float H, string Text, bool bSelected)
{
	...
	if(bSelected)
	{
		Combo.DrawClippedTexture(C, X, Y, Texture'UDebugMenu.BlueMenuHL');
		Combo.DrawStretchedTexture(C, X + 4, Y, W - 8, 16, Texture'UDebugMenu.BlueMenuHM');
		Combo.DrawClippedTexture(C, X + W - 4, Y, Texture'UDebugMenu.BlueMenuHR');
		C.SetDrawColor(0,0,0); 
	}
	else
	{
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'UDebugMenu.BlueBarL');
	W.DrawStretchedTexture( C, 16, 0, W.WinWidth - 32, 16, Texture'UDebugMenu.BlueBarTile');
	W.DrawClippedTexture(C, W.WinWidth - 16, 0, Texture'UDebugMenu.BlueBarWin');
}
...
function Menu_DrawPulldownMenuItem(UWindowPulldownMenu M, UWindowPulldownMenuItem Item, Canvas C, float X, float Y, float W, float H, bool bSelected)
{
	...
	if(Item.Caption == "-")
	{
		M.DrawStretchedTexture(C, X, Y+5, W, 2, Texture'UDebugMenu.BlueMenuLine');
		return;
	}
	...
	if(bSelected)
	{
		M.DrawClippedTexture(C, X, Y, Texture'UDebugMenu.BlueMenuHL');
		M.DrawStretchedTexture(C, X + 4, Y, W - 8, 16, Texture'UDebugMenu.BlueMenuHM');
		M.DrawClippedTexture(C, X + W - 4, Y, Texture'UDebugMenu.BlueMenuHR');
	}
...
defaultproperties 
{
	Active=Texture'UDebugMenu.BlueActiveFrame'
	Inactive=Texture'UDebugMenu.BlueInactiveFrame'
	ActiveS=Texture'UDebugMenu.BlueActiveFrameS'
	InactiveS=Texture'UDebugMenu.BlueInactiveFrameS'
	Misc=Texture'UDebugMenu.BlueMisc';
