...
//
///////////////////////////////////////////////////////////////////////////////
class DialogVendACure extends DialogGeneric;
...
function FillInLines()
{
	...
	Clear(lgreeting);
	Addto(lgreeting,							"VendacureDialog.vindacure_imamthe", 1);
	...
	Clear(lthanks);
	Addto(lthanks,								"VendacureDialog.vindacure_thanks", 1);

	Clear(lThatsGreat);
	Addto(lThatsGreat,							"VendacureDialog.vindacure_thanks", 1);
	...
	Clear(ldefiant);
	Addto(ldefiant,								"VendacureDialog.vindacure_impudenthuman", 1);

	Clear(ldefiantline);
	Addto(ldefiantline,							"VendacureDialog.vindacure_impudenthuman", 1);
	
	Clear(lCloseToWeapon);
	Addto(lCloseToWeapon,						"VendacureDialog.vindacure_goodgod", 1);

	Clear(ldecidetofight);
	Addto(ldecidetofight,						"VendacureDialog.vindacure_impudenthuman", 1);
	...
	Clear(lDoHeroics);
	Addto(lDoHeroics,							"VendacureDialog.vindacure_impudenthuman", 1);

	Clear(lgettingpissedon);
	Addto(lgettingpissedon,						"VendacureDialog.vindacure_damnitisaid", 1);

	Clear(laftergettingpissedon);
	Addto(laftergettingpissedon,				"VendacureDialog.vindacure_damnitisaid", 1);
	...
	Addto(lSomethingIsGross,					"VendacureDialog.vindacure_goodgod", 1);
	...
	Clear(ltrashtalk);
	Addto(ltrashtalk,							"VendacureDialog.vindacure_ifyouhave", 1);

	Clear(lWhileFighting);
	Addto(lWhileFighting,						"VendacureDialog.vindacure_ifyouhave", 1);
	...
	Addto(lnoticedickout,						"VendacureDialog.vindacure_ifyouhave", 1);
	...
	Clear(linvadeshome);	
	Addto(linvadeshome,							"VendacureDialog.vindacure_impudenthuman", 1);
	...
	Clear(lgetbumped);
	Addto(lgetbumped,							"VendacureDialog.vindacure_impudenthuman", 1);

	Clear(lGetMad);
	Addto(lGetMad,								"VendacureDialog.vindacure_impudenthuman", 1);

	Clear(lLynchMob);
	Addto(lLynchMob,							"VendacureDialog.vindacure_impudenthuman", 1);

	Clear(lSeesEnemy);
	Addto(lSeesEnemy,							"VendacureDialog.vindacure_impudenthuman", 1);
